...
import net.sf.mmm.bean.api.CustomHashCode;
import net.sf.mmm.bean.impl.BeanFactoryImpl;
import net.sf.mmm.bean.impl.example.CustomEqHcBean;
import net.sf.mmm.bean.impl.example.ExampleBean;
import net.sf.mmm.bean.impl.example.ExamplePojoBean;
import net.sf.mmm.bean.impl.example.ExamplePropertyBean;
import net.sf.mmm.bean.impl.example.ExtendedExampleBean;
