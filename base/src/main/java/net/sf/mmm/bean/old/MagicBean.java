...
/**
 * This is the interface for a generic bean based on {@link net.sf.mmm.property.api.WritableProperty generic
 ...
 * via reflection for each access but only once per {@link MagicBean} interface.</li>
 * <li>Dynamic - supports combination of Java's strong typing with {@link BeanAccess#isDynamic() dynamic} beans. E.g. if
 * read data from Database, XML, or JSON you can still map "undefined" properties in your {@link MagicBean}. This way a
 * client can receive an object from a newer version of a database or (REST-)service with added properties that will be
 * kept in the object and send back when the {@link MagicBean} is written back.</li>
 ...
 * <li>Flexibility - add any custom logic to your {@link MagicBean} interface via default methods including custom
 * implementations of {@link CustomEquals equals} and {@link CustomHashCode hashCode} if needed.</li>
 * <li>ReadOnly-Support - {@link BeanFactory#getReadOnlyBean(MagicBean) create} a {@link BeanAccess#isReadOnly() read-only}
 * view of your object to pass by reference without side-effects.</li>
 * <li>Powerful properties - {@link net.sf.mmm.property.api.WritableProperty} is based on JavaFx {@link Property}
 * supporting listeners and bindings but also additional features such as
 * {@link net.sf.mmm.property.api.WritableProperty#getType() generic type information}.</li>
 ...
 * </ul>
 *
 * In order to define your own bean simply create a new interface (directly or indirectly) extending this {@link MagicBean}
 * interface as in the following example:
 *
 * <pre>
 * public interface AddressBean extends {@link MagicBean} {
 *   {@link net.sf.mmm.property.api.lang.StringProperty} Street();
 *   {@link net.sf.mmm.property.api.lang.StringProperty} HouseNumber();
 *   {@link net.sf.mmm.property.api.lang.StringProperty} PostalCode();
 *   {@link net.sf.mmm.property.api.lang.StringProperty} City();
 *   {@link net.sf.mmm.property.api.lang.StringProperty} Country();
 ...
 *       System.out.println("Property '" + property.{@link net.sf.mmm.property.api.WritableProperty#getName() getName()} + "' of type ' +
 ...
 * static method to your {@link MagicBean}: <pre>
 ...
 * @since 1.0.0
 */
public interface MagicBean extends Validatable {

  /**
   * @return the {@link BeanAccess} with all generic features and methods on a {@link MagicBean}. These are encapsulated in
   *         {@link BeanAccess} to avoid polluting this {@link MagicBean} interface itself with additional methods and for
