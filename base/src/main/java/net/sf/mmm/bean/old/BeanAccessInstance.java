...
/**
 * The abstract base implementation of {@link BeanAccess} for a regular {@link MagicBean} instance.
 *
 ...
 * @since 1.0.0
 */
public abstract class BeanAccessInstance<BEAN extends MagicBean> extends BeanAccessBase<BEAN> {
  ...
  public WritableProperty<?> getProperty(String propertyName) {
    ...
    BeanClassProperty prototypeProperty = getPrototype().getPrototypeProperty(propertyName);
  ...
  void createProperties() {
    ...
    Collection<BeanClassProperty> prototypeProperties = this.prototype.getPrototypeProperties();
    ...
    for (BeanClassProperty prototypeProperty : prototypeProperties) {
  ...
  /**
   * @param prototypeProperty the {@link BeanClassProperty}.
   ...
   *         {@link BeanClassProperty}.
   */
  protected abstract WritableProperty<?> createProperty(BeanClassProperty prototypeProperty);
