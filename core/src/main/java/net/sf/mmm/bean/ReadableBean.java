...
import net.sf.mmm.validation.ValidationResultBuilder;
 ...
 * <li><b>Marshalling</b> - build-in support to {@link WritableBean#read(net.sf.mmm.marshall.StructuredReader) read} and
 * {@link #write(net.sf.mmm.marshall.StructuredWriter) write} the {@link Bean} from/to JSON, XML, or other formats.
 * Implement custom datatypes as {@link net.sf.mmm.property.Property property} and you will not need separate classes or
