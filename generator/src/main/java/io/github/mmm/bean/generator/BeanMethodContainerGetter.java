...
/**
 * {@link BeanMethodContainer} for a regular getter method.
 *
 * @since 1.0.0
 */
public class BeanMethodContainerGetter extends BeanMethodContainer {
   ...
   */
  public BeanMethodContainerGetter(Method method, String propertyName) {
